...
#' 
#' @aliases RegisterHITType hittype
...
#' @references
#' \href{http://docs.amazonwebservices.com/AWSMechTurk/latest/AWSMturkAPI/ApiReference_RegisterHITTypeOperation.htmlAPI
#' Reference: Operation}
#' 
#' \href{http://docs.amazonwebservices.com/AWSMechTurk/latest/AWSMechanicalTurkRequester/Concepts_HITTypesArticle.htmlAPI
#' Reference: Concept}
#' @keywords HITs
#' @examples
#' 
